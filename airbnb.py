...
def datafr():
    df= pd.read_csv("C:/Users/admin/Desktop/work/Project/Air BnB/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("C:/Users/admin/Desktop/work/Project/Air BnB/airbnb.jpg")
    st.image(image1)
    ...
    st.write("Project By RaghuveeR Hosamani R")
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/admin/Desktop/work/Project/Air BnB/Airbnb.csv")
            return df_a
